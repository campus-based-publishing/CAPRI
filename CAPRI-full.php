 ...
 */
	...
	class CBPPlatformDigitalObject {
		 ...
		 * Set properties
		 */
		function __construct($resultFormat="xml", $primaryFormat = "application/pdf"){
			...
			//instantiate Pest class
			$this->rest = new Pest("http://$this->username:$this->password@$this->server");
			//set the format to return results from Fedora REST API
			$this->resultFormat = $resultFormat;
			//set the "primary format" for this object for Hydra metadata
